...
import 'package:fatoorahapp/feature/purchase_invoices/add_purchase_invoice/presentation/widgets/add_invoice_product_subbmissions_buttons.dart';
...
class AddOfferToSaleInvoiceProductSheet extends StatelessWidget {
  final CreateProductEntity? productToEdit;
  final int? editIndex;

  const AddOfferToSaleInvoiceProductSheet({
    super.key,
    this.productToEdit,
    this.editIndex,
  });
                ...
                children: [
                  ProductWidget(
                    ...
                    onEditProduct: (val) {
                      ...
                      //   state.highestDiscountRate ?? "0",
                      //   state.saleProductPrice ?? "0",
                      // ));
                      }
                    },
                  ),
                  ...
                  DisCountWidget(
                    highestDiscountRate:
                        ...
                        ? num.tryParse(state.highestDiscountRate)!.toString()
                        : null,
                    ...
                    onSetValue: (val) {
                      bloc.canAddDiscount(
                        ...
                        saleProductPrice: state.saleProductPrice,
                        onSet: () {
                          bloc.add(DiscountValueChanged(val));
                        },
                  ...
                  if (state.selectedDiscountTypeId != null) ...[
                    ...
                    discountReasonWidget(
                      ...
                      initOption: state.selectedDiscountReasonId,
                    ),
                  ],
                  SizedBox(height: AppSize.s10),
                  TaxDropdownWidget(
                  ...
                  if (state.selectedTaxId != null)
                    TaxReasonWidget(
                      ...
                      state.selectedTaxReason,needsTaxReason
                    ),
                  SizedBox(height: AppSize.s20),

                  addInvoiceProductSubmissionButtons(
                    isEditMode: state.isEditMode,
                    ...
                    onSave: () {
                      if (state.selectedProduct == null) {
                        ...
                        context.read<MapOfferToInvoiceBloc>().add(
                          RecalculateAndAdjustPaymentsOfferInvoice(),
                        );
                      }
                    },
                    onSaveAndAddNew: () {
