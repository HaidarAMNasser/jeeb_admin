...
Widget addNewProductWidget(BuildContext context) {
  final exchangeBondsCreateBloc = BlocProvider.of<OfferPriceCreateBloc>(
    context,
  );
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      CustomText(text: "اضافة منتج", textStyle: getBoldStyle()),
      ...
      Container(
        ...
        child: Row(
          ...
          children: [
              ...
              onTap: () {
                ...
                DialogsAndPopUp.customBottomSheet(
                  ...
                  child: MultiBlocProvider(
                    ...
                    providers: [
                      BlocProvider.value(value: exchangeBondsCreateBloc),
            ...
            CustomText(text: "اضافة منتج", textStyle: getRegularStyle()),
          ],
        ),
      ),
    ],
