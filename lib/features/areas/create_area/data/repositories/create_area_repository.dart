...
import 'package:jeeb_admin/features/areas/create_area/data/data_sources/create_area_data_source.dart';
...
class CreateAreaRepository {
  final CreateAreaRemoteDataSource _remoteDataSource;
  final NetworkInfo _networkInfo;

  const CreateAreaRepository(
