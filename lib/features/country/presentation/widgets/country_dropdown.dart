      ...
      builder: (context, state) {
        if (state is CountryLoading) {
          return Column(
            ...
            children: [
              CustomText(
                text: AppTranslation.selectCountry,
        ...
        if (state is CountryLoaded) {
          ...
          final displayText = selectedCountry != null
              ? (isRTL ? selectedCountry.name.ar : selectedCountry.name.en)
          ...
          return Column(
            ...
            children: [
                    ...
                    children: [
                      Expanded(
                        child: CustomText(
                          ...
                          textStyle: getRegularStyle(
                            fontSize: AppFontSize.s14,
                            color: widget.selectedCountryId != null
              ...
              if (_isExpanded && countries.isNotEmpty)
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: countries.length + (state.hasReachedMax ? 0 : 1),
