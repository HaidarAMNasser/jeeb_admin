        ...
        return BlocConsumer<CreateProductBloc, CreateProductState>(
          ...
          builder: (context, createState) {
            return ModalProgressHUD(
              ...
              inAsyncCall:
                  createState is CreateProductLoading || updateState is UpdateProductLoading,
              child: Scaffold(
                ...
                body: isEdit
                    ? BlocStateHandler<ProductDetailsBloc, ProductDetailsState>(
                        ...
                        successBuilder: (context, productDetailsState) {
                          final loadedState = productDetailsState as ProductDetailsLoaded;
                          // Initialize form with fetched product data
                          WidgetsBinding.instance.addPostFrameCallback((_) {
                            if (mounted) {
                              context.read<CreateProductBloc>().add(
                                InitializeProductForm(product: loadedState.product),
                              );
                            }
                          });
