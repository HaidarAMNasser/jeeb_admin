...
import 'package:jeeb_admin/features/order/order_complete/data/data_sources/order_complete_data_source.dart';

class OrderCompleteRepository {
  final OrderCompleteRemoteDataSource _remoteDataSource;
  final NetworkInfo _networkInfo;

  const OrderCompleteRepository(
    this._remoteDataSource,
    this._networkInfo,
  );

  Future<Either<Failure, void>> completeOrder(String id) async {
