...
import 'package:jeeb_admin/features/merchant/delete_merchant/data/data_sources/delete_merchant_data_source.dart';

class DeleteMerchantRepository {
  final DeleteMerchantRemoteDataSource _remoteDataSource;
  final NetworkInfo _networkInfo;

  const DeleteMerchantRepository(
  ...
  Future<Either<Failure, void>> deleteMerchant(String id) async {
    if (await _networkInfo.isConnected) {
      try {
        final response = await _remoteDataSource.deleteMerchant(id);
