...
class _AppApiServiceClientImpl implements AppApiServiceClient {
  ...
  @override
  Future<Response> getCategories(int? page, int? limit, String? search) async {
    const extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<Response> getAreaDetails(String id) async {
    const extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final headers = <String, dynamic>{};
  ...
  @override
  Future<Response> deleteArea(String id) async {
    const extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final headers = <String, dynamic>{};
  ...
  @override
  Future<Response> confirmOrder(String id, Map<String, dynamic>? body) async {
    const extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final headers = <String, dynamic>{'Content-Type': 'application/json'};
  ...
  @override
  Future<Response> setOrderPreparing(String id) async {
    const extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final headers = <String, dynamic>{};
  ...
  @override
  Future<Response> setOrderReadyForPickup(String id) async {
    const extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final headers = <String, dynamic>{};
