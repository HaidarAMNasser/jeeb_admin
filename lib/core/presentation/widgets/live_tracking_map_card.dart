...
import 'package:jeeb_admin/core/presentation/maps/route_history_polyline_builder.dart';
...
/// Live map: driver-centered camera, path from RTDB `routeHistory`, dashed line to drop-off.
...
class _LiveTrackingMapCardState extends State<LiveTrackingMapCard> {
  ...
  Set<Polyline> _buildPolylines() {
    ...
    final walked =
        RouteHistoryPolylineBuilder.walkedPath(orderId: id, points: latLngs);
  ...
  Widget build(BuildContext context) {
    final chipColor =
        (widget.statusOnline ?? false) ? ColorManager.info : Colors.orange;
